...
class Capabilities extends Component {
    render() {
        return (
            <div className="v2-agency-section3">
                <div className="v2-wrapper">
                    ...
                    <div className="agency-capabilities-circle cc1"
                         style={{
                             willChange: 'transform',
                             transform: 'translate3d(-27.4788px, -14.754px, 0px) scale3d(0.908404, 0.908404, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
                             transformStyle: 'preserve-3d'
                         }}/>
                    <div className="agency-capabilities-circle cc2"
                         style={{
                             willChange: 'transform',
                             transform: 'translate3d(-27.4788px, -24.59px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)',
                             transformStyle: 'preserve-3d'
                         }}/>
                    <img
